"""
Linear model implementation for DoS detection.
"""
...
def create_linear_model(
    ...
    """
    Create a simple linear model with dense layers.
    ...
    logger.info(f"Created linear model with {len(hidden_units)} hidden layers")
