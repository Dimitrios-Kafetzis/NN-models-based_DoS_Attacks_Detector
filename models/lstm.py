"""
LSTM model implementation for DoS detection.
"""
...
def create_lstm_model(
    ...
    """
    Create an LSTM-based model for DoS detection.
    ...
    for i, units in enumerate(lstm_units):
        ...
        # Add normalization between LSTM layers
    ...
    logger.info(f"Created {'bidirectional ' if bidirectional else ''}LSTM model with {len(lstm_units)} LSTM layers")
